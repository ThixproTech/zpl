...
import autoWorkController from "./autoWorkController.js";
...
const cronJobGame1p = (io) => {
  ...
  cron.schedule("0 1 * * *", async () => {
    ...
    // await userController.recruiterBonus();
    // await incomeController.fetchTodayRecharges();
    await incomeController.userLevelInfo();
    await incomeController.myTeamRank();
  });
  ...
  // Schedule task to run at 11:55 PM every day
  cron.schedule("55 23 * * *", async () => {
    console.log("Running autoWorkController at 11:55 PM...");
    try {
      await autoWorkController.rewardCollectAutoForAllUsers(); // Call your controller function
      await autoWorkController.bettingReward();
      await autoWorkController.teamRechargeReward();
      // await autoWorkController.topRecruiterReward();
      await autoWorkController.rankIncomeSlabReward();
      console.log("autoWorkController executed successfully!");
    } catch (error) {
      console.error("Error executing autoWorkController:", error);
    }
  }, {
    scheduled: true,
