...
import pdfStatementController from "../controllers/pdfStatementController.js";
...
import {
  getIGTECHGameHistory,
  getIGtechGameLink,
  IGTECHCallbak,
} from "../controllers/igtectController.js";
...
const initWebRouter = (app) => {
  ...
  router.get("/igtechhistory", homeController.historyPage);
  router.get("/igtechgamewindow", homeController.gamewindowPage);
  router.get("/igtechallgames", homeController.AllgamesPage);
  // router.get("/jdbgames", homeController.JDBgamesPage);
  // router.get("/jiligames", homeController.JiligamesPage);
  // router.get("/spribegames", homeController.SpribegamesPage);
  // router.get("/cq9games", homeController.CQ9gamesPage);
  // router.get("/microgames", homeController.MicrogaminggamesPage);
  // router.get("/pgsoftgames", homeController.PgSoftgamesPage);
  router.get(
    "/jili/game_link",
  ...
  router.post("/api/send_reg_otp", accountController.sendUserRegOtpCode);
  router.post(
    "/api/reset_password",
  ...
  router.get("/api/rebateFun", middlewareController, homeController.rebateFun);
  router.post(
    "/api/claimRebate",
    middlewareController,
    homeController.claimRebate
  );
  router.post(
    "/api/claimRebate",
    middlewareController,
  ...
  router.post(
    "/api/webapi/vip_claim",
    middlewareController,
    vipController.claimVIPLevelUp
  );
  ...
  router.post(
    "/load_game_history",
    middlewareController,
    homeController.loadGameHistory
  );
  router.get(
    "/inviteBonus",
    middlewareController,
    homeController.inviteBonusPage
  );
  ...
  router.get(
    "/promotion/directDeposit",
    middlewareController,
    homeController.directDepositPage
  );

  router.get(
    "/promotion/roiIncome",
    middlewareController,
    homeController.roiIncomePage
  );

  router.get(
    "/promotion/firstRecharge",
    middlewareController,
    homeController.firstRechargePage
  );

  router.get(
    "/promotion/topRecruiter",
    middlewareController,
    homeController.topRecruiterPage
  );

  router.get(
    "/promotion/deffirencial",
    middlewareController,
    homeController.deffirencialPage
  );

  router.get(
    "/promotion/teamRecharge",
    middlewareController,
    homeController.teamRechargePage
  );

  router.get(
    "/promotion/jackpot",
    middlewareController,
    homeController.jackpotIncomePage
  );

  router.get(
    "/promotion/betIncome",
    middlewareController,
    homeController.betIncomePage
  );

  router.get(
    "/promotion/franchise",
    middlewareController,
    homeController.franchisePage
  );

  router.get(
    "/promotion/salaryIncome",
    middlewareController,
    homeController.salaryIncomePage
  );

  router.get(
    "/promotion/dailySalary",
    middlewareController,
    homeController.dailySalaryPage
  );

  router.get(
    "/promotion/attendance",
    middlewareController,
    homeController.attendanceBonusPage
  );

  router.get(
    "/promotion/myReferral",
    middlewareController,
    homeController.myReferralPage
  );

  router.get(
    "/promotion/myDownline",
    middlewareController,
    homeController.myDownlinePage
  );

  router.get(
    "/promotion/levelDetails",
    middlewareController,
    homeController.levelDetailsPage
  );
  ...
  router.post(
    "/api/webapi/bonus_history",
    middlewareController,
    promotionController.bonusHistory
  );
  router.get(
  ...
  router.post("/wallet/verify/upi", paymentController.verifyOnlinePayment);
  router.get(
    "/wallet/paynow/rspay",
    middlewareController,
  ...
  // IGTech Router
  router.get("/api/webapi/get-game-link", getIGtechGameLink);
  router.post("/api/webapi/igtechcallback", IGTECHCallbak);
  router.get("/api/webapi/igtechgamehistory", getIGTECHGameHistory);

  router.get(
    "/api/webapi/loteryGameHistory",
    adminController.loteryGameHistory
  );
  ...
  router.get(
    "/api/webapi/listredenvelopes",
    middlewareController,
    userController.listredenvelopes
  ); // register
  // --

  router.get(
    "/api/webapi/first/recharge/list",
    middlewareController,
    incomeController.firstListRecharge
  ); // register
  router.get(
    "/api/webapi/salary/record",
    middlewareController,
    incomeController.SalaryRecord
  );
  router.get(
    "/api/webapi/daily/salary/record",
    middlewareController,
    incomeController.dailySalaryRecord
  );
  router.get(
    "/api/webapi/recruiter/salary/record",
    middlewareController,
    incomeController.recruiterSalaryRecord
  );
  router.get(
    "/api/webapi/franchise/income",
    middlewareController,
    incomeController.franchiseIncome
  );
  router.get(
    "/api/webapi/roi/income",
    middlewareController,
    incomeController.roiIncome
  );
  router.get(
    "/api/webapi/my/referral",
    middlewareController,
    incomeController.myReferral
  );
  ...
  router.post(
    "/admin/manager/settings/changePassword",
    adminController.middlewareAdminController,
    adminController.settingChangePassword
  ); // get info account
  router.post(
  ...
  router.post(
    "/admin/member/listTransfer/:phone",
    adminController.middlewareAdminController,
    adminController.listTransferMem
  );
  router.post(
  ...
  router.post(
    "/admin/member/listRebete/:phone",
    adminController.middlewareAdminController,
    adminController.listRebeteMem
  );
  router.post(
  ...
  router.post(
    ...
    adminController.middlewareAdminController,
    adminController.listApiBet
  );
  router.post(
    "/admin/member/bonus/:phone",
    adminController.middlewareAdminController,
    adminController.listBonus
  );

  router.post(
    "/admin/member/userPasswordAndReferral/:phone",
    adminController.middlewareAdminController,
    adminController.userPasswordAndReferral
  );
  ...
  router.get(
    "/admin/manager/igtechadmingamehistory",
    adminController.middlewareAdminController,
    adminController.adminHistorypage
  );
  router.get(
    "/admin/manager/loteryAdminGameHistory",
    adminController.middlewareAdminController,
    adminController.adminLoteryGameHistorypage
  );
  router.get(
  ...
  router.get(
    "/admin/manager/depositeWithdraw",
    adminController.middlewareAdminController,
    adminController.depositeWithdraw
  );
  router.get(
    "/admin/manager/adminBonusHistory",
    adminController.middlewareAdminController,
    adminController.adminBonusHistory
  );
  router.get(
    "/admin/manager/p2pRecord",
    adminController.middlewareAdminController,
    adminController.p2pRecord
  ); // get info account
  router.post(
    "/api/webapi/admin/p2pRecordfilter",
    adminController.middlewareAdminController,
    adminController.p2pRecordfilter
  );
  router.get(
  ...
  router.post(
    "/api/webapi/admin/depositeWithdrawRecord",
    adminController.middlewareAdminController,
    adminController.depositeWithdrawRecord
  );
  router.post(
    "/api/webapi/admin/adminBonusHistoryFilter",
    adminController.middlewareAdminController,
    adminController.adminBonusHistoryFilter
  );
  router.post(
    "/api/webapi/admin/recordFilter",
    adminController.middlewareAdminController,
    adminController.recordFilter
  );
  router.post(
  ...
  router.post(
    "/api/webapi/admin/recharge/update",
    adminController.middlewareAdminController,
    paymentController.updateRechargeAmount
  );
  ...
  router.get(
    "/admin/manager/OTH",
    adminController.middlewareAdminController,
    adminController.adminPageOTH
  ); // get info account
  router.post(
    "/admin/manager/settings/getOTH",
    adminController.middlewareAdminController,
    adminController.settingGetOTH
  ); // get info account
  router.post(
    "/admin/manager/settings/oth",
    adminController.middlewareAdminController,
    adminController.settingOTH
  ); // get info account
  router.post(
    "/api/updateMoney",
    adminController.middlewareAdminController,
    adminController.updateTheMoney
  );
  router.post(
    "/api/addBankInfo/:id",
    adminController.middlewareAdminController,
    adminController.addBankInfo
  );

  router.get("/casino/getCasinogames" , 
    userController.getCasinoGames

  )
  
  router.get('/download-member-pdf', pdfStatementController.memberListPdf);
