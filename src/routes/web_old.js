...
const initWebRouter = app => {
   // page account
   router.get("/admin/manager/gamehistory ", adminController.middlewareAdminController, adminController.adminHistorypage); // get info account
   ...
   // IGTECH GAMING 
   router.get("/admin/manager/igtechadmingamehistory", adminController.middlewareAdminController, adminController.adminHistorypage); 
